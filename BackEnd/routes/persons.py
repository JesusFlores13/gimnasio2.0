...
@persons.get("/persons/", response_model=List[schemas.persons.Person], tags=["Personas"] ,dependencies=[Depends(Portador())])
...
@persons.post("/person/{ID}", response_model=schemas.persons.Person, tags=["Personas"] ,dependencies=[Depends(Portador())])
...
@persons.post("/persons/", response_model=schemas.persons.Person, tags=["Personas"])
...
@persons.put("/person/{ID}", response_model=schemas.persons.Person, tags=["Personas"] ,dependencies=[Depends(Portador())])
...
@persons.delete("/person/{ID}", response_model=schemas.persons.Person, tags=["Personas"] ,dependencies=[Depends(Portador())])
